  ...
  <div aria-hidden='true' className={OVERLAY}>
    <div className='absolute inset-[-60%]' style={{ transform: run.back ? 'rotate(12deg) scaleX(-1)' : 'rotate(-12deg)' }}>
      <div className='absolute inset-0' style={{ animation: WIPE_ANIMATION[run.phase] }} onAnimationEnd={onSettled}>
        ...
        <span className='absolute top-[55%] left-[48%] size-0.5 animate-[twinkle_1.1s_ease-in-out_.3s_infinite] rounded-full bg-(--star-ice)' />
        <span className='absolute top-[44%] left-[72%] size-0.5 animate-[twinkle_1.6s_ease-in-out_.6s_infinite] rounded-full bg-(--star-lilac)' />
        <div className='absolute inset-y-0 left-0 w-12 bg-[linear-gradient(90deg,rgba(4,254,255,.28),rgba(4,254,255,0))]' />
