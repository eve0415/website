...
import StatRow from './StatRow/stat-row';
...
const StatsPanel: FC<StatsPanelProps> = ({ stats, animate }) => (
  <div className='w-full max-w-md'>
    ...
    <div className='mb-6'>
      ...
      <div className='border-line bg-surface/50 rounded border px-4 py-2'>
    ...
    <div className='text-subtle-foreground mt-6 flex gap-4 font-mono text-xs'>
      <span>
