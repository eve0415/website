...
const BASE = tw(
  'ev-on-panel inline-block rounded-[999px] border border-(--line-accent) bg-(--surface-toast) px-5.5 py-3 font-sans text-(length:--text-nav) text-[#d8f9ff] shadow-(--glow-toast)',
);
