...
const Kira: FC = () => (
  <span
    aria-hidden='true'
    className='absolute top-[-4px] right-[-4px] size-[11px] transform-[scale(0)] animate-[evLangKira_.55s_ease-in-out_.12s_both] bg-(--star-white) drop-shadow-[0_0_5px_rgba(4,254,255,.9)] [clip-path:var(--shape-sparkle)]'
  />
);
