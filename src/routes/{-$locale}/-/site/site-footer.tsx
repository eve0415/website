...
const ROOT = tw(
  'ev-on-clouds relative border-t border-t-(--line-header) bg-[radial-gradient(120%_220%_at_50%_135%,var(--sky-footer-glow),transparent_60%)] p-[20px_clamp(20px,4vw,40px)_26px] font-sans text-(length:--text-small) text-(--ink-faint)',
);
