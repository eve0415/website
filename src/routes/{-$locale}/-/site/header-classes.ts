 ...
 */
export const BRAND_CLASS = tw('flex min-h-(--hit-target) items-center gap-2.5 text-[1rem] font-bold text-(--ink-nav) no-underline hover:text-(--accent)');
 ...
 */
export const TRAILING_CLASS = tw('ml-[calc(clamp(10px,2vw,22px)-12px)] flex-none');
