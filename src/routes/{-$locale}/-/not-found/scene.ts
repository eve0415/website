...
export const SPARKLE = '[clip-path:polygon(50%_0%,61%_39%,100%_50%,61%_61%,50%_100%,39%_61%,0%_50%,39%_39%)]';
...
export const CLOUD_BAND = 'absolute top-0 right-[-80px] bottom-[-20px] left-[-80px]';

export const MASK_BAND_BACK = '[mask:linear-gradient(180deg,transparent_0%,rgba(0,0,0,.5)_30%,#000_55%)_50%_50%/100%_100%_no-repeat]';
export const MASK_BAND_FRONT = '[mask:linear-gradient(180deg,transparent_0%,rgba(0,0,0,.5)_26%,#000_50%)_50%_50%/100%_100%_no-repeat]';
