/* oxlint-disable react/react-compiler -- setPathRef returns a ref callback invoked after render, not during render */
...
const Logo: FC<Props> = ({ className = '', animate = true }) => {
  ...
  return (
    // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- SVG is not an img
