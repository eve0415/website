/* oxlint-disable react/jsx-no-comment-textnodes -- Intentionally displays code comments as visual elements */
/* oxlint-disable react/no-array-index-key -- Static decorative arrays in visualization */
