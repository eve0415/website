...
export const curseforge = (
  <svg viewBox='0 0 24 24' className={css({ height: '1.5rem', width: '1.5rem' })}>
...
export const discord = <BsDiscord color='#5865F2' />;
export const github = <GrGithub color='#181616' />;
export const crowdin = <SiCrowdin color='#2E3340' />;
export const twitter = <GrTwitter color='#1D9BF0' />;
export const homepage = <GrLanguage />;
